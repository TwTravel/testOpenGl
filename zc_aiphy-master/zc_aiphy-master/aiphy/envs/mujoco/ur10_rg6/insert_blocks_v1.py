...
class InsertBlocksEnvV1(UR10RG6AngleToolEnv, utils.EzPickle):
    def __init__(self, model_path='ur10_rg6_insert_block.xml', frame_skip=40, max_speed=0.5, ctrl_hz=6.25,
