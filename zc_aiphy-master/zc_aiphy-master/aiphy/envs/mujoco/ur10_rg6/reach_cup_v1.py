...
class ReachCupEnvV1(UR10RG6AngleToolEnv, utils.EzPickle):
    def __init__(self, model_path='ur10_rg6_cup_can.xml', frame_skip=40, max_speed=0.5, ctrl_hz=6.25,
                 initial_robot_pos_dict=DEFAULT_INITIAL_QPOS,
                 object_range=0.15,
                 target_range=0.15,
                 target_offset=0.0,
                 distance_threshold=0.02, reward_type='sparse', action_type='rel',
    ...
    def _angele_move_rule(self, act):
        ...
        try:
            ...
            arm_action = self.robot_get_obs()[0]
            print("act", act, self.robot_get_obs()[0])
        return arm_action
